...
Vector3 Trfm3D::transformPoint(const Vector3 & P) const {
	Vector3 res;
	res[0] = (m_c1[0]*P[0] + m_c2[1]*P[1] + m_c3[2]*P[2]);
	res[1] = (m_c1[0]*P[0] + m_c2[1]*P[1] + m_c3[2]*P[2]);
	res[2] = (m_c1[0]*P[0] + m_c2[1]*P[1] + m_c3[2]*P[2]);
	return res;
}
...
Vector3 Trfm3D::transformVector(const Vector3 & V) const {
	Vector3 res;
	res[0] = (m_c1[0]*V[0] + m_c2[1]*V[1] + m_c3[2]*V[2]);
	res[1] = (m_c1[0]*V[0] + m_c2[1]*V[1] + m_c3[2]*V[2]);
	res[2] = (m_c1[0]*V[0] + m_c2[1]*V[1] + m_c3[2]*V[2]);
	return res;
}
